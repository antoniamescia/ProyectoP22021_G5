        ...
        private static async void OnMessage(object sender, MessageEventArgs messageEventArgs)
        {
            ...
            if (messageText != null)
            {
                ...
                switch (messageText)
                {
                    ...
                    case "/foto":
                    case "/photo":
                        using (Stream stream = System.IO.File.OpenRead("../../docs/67195573.jpeg"))
                        {
                            await client.SendPhotoAsync(
                                            chatId: chatInfo.Id,
                                            photo: stream,
                                            caption: "<b>Luis Miguel</b>. <i>Source</i>: <a href=\"https://www.meme-arsenal.com/en/create/meme/497325\">Meme Arsenal</a>",
